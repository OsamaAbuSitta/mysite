    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            <span className="text-foreground">Osama</span>{' '}
            <span className="text-primary">Abu Sitta</span>
          </motion.h1>
          ...
          >
           Solutions Architect • Cloud Architect • DevOps • Development Strategy  {/*  • Consultant */}
          </motion.h2>
          ...
          >
            Designing resilient systems, shaping development strategy, and leading teams to enterprise success.
          </motion.p>
